...
- Run ID: `hybrid-config-check-final`
...
- Browser events: `qa/reports/runs/hybrid-config-check-final/browser/events.jsonl`
- Static routes/forms: `qa/reports/runs/hybrid-config-check-final/static-routes/result.json`
- Static API risks: `qa/reports/runs/hybrid-config-check-final/static-risks/result.json`
- Screenshots: `qa/reports/runs/hybrid-config-check-final/browser/screenshots`
