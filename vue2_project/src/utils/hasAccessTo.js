...
const rolesHasAccessToMap = {
	...
	view_corporate: { app_section: MENU_TYPES.CORPORATE_ANALYTICS, permissions: ['is_viewing'] },
	...
	create_settings: {
		app_section: MENU_TYPES.SETTINGS,
		permissions: ['is_creating']
	},
	...
	create_requisitions_roi_calculator: {
		app_section: MENU_TYPES.REQUISITIONS_ROI_CALCULATOR,
		permissions: ['is_creating']
	},
	edit_requisitions_roi_calculator: {
		app_section: MENU_TYPES.REQUISITIONS_ROI_CALCULATOR,
		permissions: ['is_updating']
	},
	delete_requisitions_roi_calculator: {
		app_section: MENU_TYPES.REQUISITIONS_ROI_CALCULATOR,
		permissions: ['is_deleting']
	},

	create_work_order_requests: {
		app_section: MENU_TYPES.WORK_ORDER_REQUESTS,
		permissions: ['is_creating']
	},
	edit_work_order_requests: {
		app_section: MENU_TYPES.WORK_ORDER_REQUESTS,
		permissions: ['is_updating']
	},
	delete_work_order_requests: {
		app_section: MENU_TYPES.WORK_ORDER_REQUESTS,
		permissions: ['is_deleting']
	},

	create_task_procedures: {
		app_section: MENU_TYPES.TASK_PROCEDURES,
		permissions: ['is_creating']
	},
	edit_task_procedures: {
		app_section: MENU_TYPES.TASK_PROCEDURES,
		permissions: ['is_updating']
	},
	delete_task_procedures: {
		app_section: MENU_TYPES.TASK_PROCEDURES,
		permissions: ['is_deleting']
	},
	...
	create_import_work_orders: {
		app_section: MENU_TYPES.IMPORT_WORK_ORDERS,
		permissions: ['is_creating']
	},
	edit_import_work_orders: {
		app_section: MENU_TYPES.IMPORT_WORK_ORDERS,
		permissions: ['is_updating']
	},
	delete_import_work_orders: {
		app_section: MENU_TYPES.IMPORT_WORK_ORDERS,
		permissions: ['is_deleting']
	},
	...
	create_import_plant_logs: {
		app_section: MENU_TYPES.IMPORT_PLANT_LOGS,
		permissions: ['is_creating']
	},
	edit_import_plant_logs: {
		app_section: MENU_TYPES.IMPORT_PLANT_LOGS,
		permissions: ['is_updating']
	},
	delete_import_plant_logs: {
		app_section: MENU_TYPES.IMPORT_PLANT_LOGS,
		permissions: ['is_deleting']
	},

	create_import_master: {
		app_section: MENU_TYPES.IMPORT_MASTER,
		permissions: ['is_creating']
	},
	edit_import_master: {
	...
	delete_equipment_types_categories: {
		app_section: MENU_TYPES.EQUIPMENT_TYPES_CATEGORIES,
		permissions: ['is_deleting']
	},
