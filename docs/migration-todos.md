...
- DONE (section): migrated `vue2_project/src/views/Settings` into Vue3 except `Settings/Import`, including Settings shell navigation, Faults/NCD Faults, Custom Formulas, Back-End Register Writing, Bearings, Lube Types, Industrial Services, Statistics export, Banner V2 Subtypes, `useSettings`, entity configs, active routes, and Settings sidebar menu entry.
