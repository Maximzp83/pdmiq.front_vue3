...
const menuItems1 = [
	...
	/*{
		name: 'Service',,
		name: 'sidebar_menu.Service',
		category_label: 'service'
	},

	{
		// name: 'Admins',
		name: 'sidebar_menu.Admins'
		meta: { userTypes: [USER_TYPES.SUPER_ADMIN, USER_TYPES.DISTRIBUTOR] }
	},*/
	...
	/*{
		...
		path: '/sensors',
		meta: {
			userTypes: [USER_TYPES.SUPER_ADMIN, USER_TYPES.DISTRIBUTOR, USER_TYPES.PLANT_USER]
		}
	},
	{
		name: 'Lubricators',
		name: 'sidebar_menu.Lubricators'
		icon: 'icon-oil-drum',
		path: '/pumps',
		meta: {
		...
		children: [
			{
				// name: 'Radio Nodes',
				name: 'sidebar_menu.Nodes'
				icon: 'icon-clock',
				path: '/radios'
			},
			{
				// name: 'Pumps',
				name: 'sidebar_menu.Pumps'
				icon: 'icon-clock',
				path: '/pumps'
			}
		]
	...
	/*{
		...
		icon: 'icon-testing',
		path: '/testing',
		meta: { userTypes: [USER_TYPES.SUPER_ADMIN] }
	},*/
	/*{
		name: 'Faults',
		icon: 'icon-warning',
