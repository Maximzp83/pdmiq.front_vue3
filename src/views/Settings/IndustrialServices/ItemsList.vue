...
defineOptions({
	name: 'SettingsIndustrialServicesList',
});

const itemsTableRef = ref(null);
const itemStore = useIndustrialServicesStore();
const { filters } = storeToRefs(itemStore);
const authStore = useAuthStore();
const entity = ENTITIES.IndustrialServices;
...
const tableSettings = computed(() => {
	...
	return {
		columns: translate([{ prop: 'name', label: 'Name', sortable: true }]),
